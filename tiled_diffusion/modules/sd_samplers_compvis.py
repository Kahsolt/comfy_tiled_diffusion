...
samplers_data_compvis = [
    ...
    SamplerData('UniPC', lambda model: VanillaStableDiffusionSampler(UniPCSampler, model), [], {}),
]
...
class VanillaStableDiffusionSampler:
    ...
    def before_sample(self, x, ts, cond, unconditional_conditioning):
        ...
        unconditional_conditioning = reconstruct_cond_batch(unconditional_conditioning, self.step)
